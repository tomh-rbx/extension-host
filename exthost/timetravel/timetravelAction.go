...
var (
  _ action_kit_sdk.Action[StressActionState]         = (*timetravelAction)(nil)
  _ action_kit_sdk.ActionWithStop[StressActionState] = (*timetravelAction)(nil) // Optional, needed when the action needs a stop method
)

func NewTimetravelAction() action_kit_sdk.Action[StressActionState] {
  return &timetravelAction{}
}

func (l *timetravelAction) NewEmptyState() StressActionState {
...
func (l *timetravelAction) Start(_ context.Context, state *StressActionState) (*action_kit_api.StartResult, error) {
  if state.DisableNtp {
